...
int fork ()
{
	...
	segment = (pPrev -> uss + 0x800);		// child segment is the previous segment + 32KB (800 in hex)
	copyImage (running -> uss, segment, 16*1024);	// copy the whole 16k words
